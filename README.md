...
- **SneakerNest** – E-commerce platform for sneakers  
  Built with Node.js, MySQL, React.js, Docker.  

- **AI Navigation App** – Mobile app for object detection & indoor navigation  
  Used YOLO for real-time tracking through camera feed.
